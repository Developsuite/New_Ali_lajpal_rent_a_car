...
function OurCars({ limit = null, hideHeader = false, showFilters = false }) {
  ...
  const filteredCars = carsData.filter(car => {
    ...
    // Search - matches model, make, and full display name (e.g. 'suzuki' finds Suzuki Wagon R)
    if (filters.search && !displayName.toLowerCase().includes(filters.search.toLowerCase())) return false;
                  ...
                  <div className="car-card" key={car.id}>
                    <div className="car-card__inner">
                      <div className="car-card__image-wrapper">
                        <img src={car.image} alt={`${displayName} available for rent in Lahore`} className="car-card__img" loading="lazy" />
