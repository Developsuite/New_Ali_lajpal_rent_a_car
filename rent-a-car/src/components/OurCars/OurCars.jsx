                    ...
                    <div className="car-card__content">
                      <div className="car-card__main">
                        ...
                        <div className="car-card__bottom">
                          ...
                          <div className="car-card__action-buttons" style={{ display: 'flex', gap: '8px', width: '100%' }}>
                    <Link to={`/car/${car.id}`} className="car-card__details-btn" style={{ flex: 1, textAlign: 'center', background: '#f0f0f0', color: '#333', padding: '7px 0', borderRadius: '8px', fontSize: '0.78rem', fontWeight: '600', textDecoration: 'none', transition: 'all 0.3s ease' }}>
                      Details
                    </Link>
                    <a 
