      ...
      <div className="why-choose__carousel-wrapper">
        <div className="why-choose__grid container">
          ...
          <div className="why-card why-card--text-up">
            <div className="why-card__inner">
              ...
              <div className="why-card__image-wrapper">
                <img src="/imagess/our_services/car-rental-bahria-town-lahore.webp" alt="Flexible Rentals" className="why-card__img" />
          ...
          <div className="why-card why-card--text-down">
            <div className="why-card__inner">
              <div className="why-card__image-wrapper">
                <img src="/imagess/our_services/rent-a-car-service-bahria-town-lahore.webp" alt="Wide Range of Vehicles" className="why-card__img" />
          ...
          <div className="why-card why-card--text-up">
            <div className="why-card__inner">
              ...
              <div className="why-card__image-wrapper">
                <img src="/imagess/our_services/best-car-rent-bahria-town-lahore.webp" alt="City to City Drops" className="why-card__img" />
                <div className="why-card__gradient why-card__gradient--bottom"></div>
              </div>
            </div>
          </div>
